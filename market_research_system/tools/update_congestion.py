...
CONGESTION_JSON = DATA_DIR / "congestion_data.json"
...
def fetch_congestion_data():
    try:
        ...
        with CONGESTION_JSON.open('w', encoding='utf-8') as f:
            json.dump(final_json, f, ensure_ascii=False, indent=2)

        print(f"Done! congestion_data.json updated. Latest valid close: {latest_trade_date}")
        print(f"Output: {CONGESTION_JSON}")
        c.stop()
